...
<?php 
$pembeliygbeli=$detail["id_pembeli"];

$pembeliyglogin= $_SESSION["pembeli"]["id_pembeli"];
...
<h4><strong>Pembelian</strong></h4>
	No. Pembelian	: <?php echo $detail['id_faktur']; ?> <br>
	Tanggal	Pembelian : <?php echo $detail['tanggal']; ?> <br>
</div>
<div class="col-md-4"></div>
	<div class="col-md-4"> 
		<h4><strong>Pelanggan</strong></h4>
	 <strong><?php echo $detail['nama'];?></strong><br> 
Email : <?php echo $detail['email_cust'];?><br> 
Alamat	: <?php echo $detail['alamat']; ?> <br>
No Telp	: <?php echo $detail['no_telp']; ?> <br>
	</div>
</div>
<table class="table table-bordered">
	...
	<tbody>
		<?php $nomor=1; ?>
		<?php $totalbelanja=0;?>
		<?php $ambil=$koneksi->query("SELECT * FROM transaksi INNER JOIN sepatu ON transaksi.id_faktur='$_GET[id]' 
		AND transaksi.id_sepatu=sepatu.id_sepatu INNER JOIN merk_sepatu
										ON merk_sepatu.id_merk = sepatu.id_merk
		...
		<tr>
			...
			<td> 
				Rp.<?php echo number_format($pecah['harga']*$pecah['jumlah']); ?> </td>
			</td>
		</tr>
		<?php $totalbelanja+=($pecah['harga']*$pecah['jumlah']);?>
		<?php $nomor++ ?>
		<?php } ?>
	</tbody>
	<tfoot>
...
<div class="row">
				...
				<div class="col-md-7">
					<div class="alert alert-danger">
						...
						Tanggal Pembayaran : <?php echo ($detail['tanggal_pembayaran']); ?>
					</div>
					<div class="alert alert-info">
						<strong>No. Rek Pembayaran BCA 2677084407 A/N Farasya Najmi</strong>
					</div>
				</div>
			</div>
			</div>
