...
$id_pembeli_login=$_SESSION["pembeli"]["id_pembeli"];

if($id_pembeli_login!==$id_pembeli_beli)
{
	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			...
			<div class = "container">
				...
				<div class="alert alert-info">Total Pembayaran Anda <strong>Rp. <?php echo number_format($detpem["total_harga"]) ?></div>

				<form method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label>Nama Pembeli</label>
						<input type="text" class="form-control" name="nama" readonly value="<?php echo $_SESSION["pembeli"]['nama']?>">
					</div>
					<div class="form-group">
						<label>Bank</label>
					...
					<div class="form-group">
						...
						<p class="text-danger">Foto Bukti Harus JPG Maksimal 5MB</p>
					</div>
			...
			if(isset($_POST["kirim"]))
			{
				...
				$koneksi->query("UPDATE faktur SET bank='$bank', bukti_pembayaran='$namafiks',tanggal_pembayaran='$tanggal'
