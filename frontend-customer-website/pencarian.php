...
$semuadata = array();
$ambil=$koneksi->query("SELECT * FROM sepatu WHERE nama_sepatu LIKE '%$keyword%'");
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-7 col-md-9">
							<div id="colorlib-logo"><a href="index.html">Neo City</a></div>
						</div>
...
<body>
	<div class="container">
		...
		<?php if(empty($semuadata)) : ?>
			<div class="alert alert-danger">Sorry! <strong><?php echo $keyword ?></strong> not found :(</div>
		<?php endif ?>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="thumbnail">
					<img src="../gambar_produk/<?php echo $value['gambar_sepatu']; ?>" width="200">
					<div class="caption">
						<h3><?php echo $value['nama_sepatu']; ?></h3>
						<h5>Rp. <?php echo number_format($value['harga']); ?> </h5>
						<a href="beli.php?id=<?php echo $value['id_sepatu']; ?>" class="btn btn-primary">Beli</a>
						<a href="product-detail.php?id=<?php echo $value["id_sepatu"]; ?>" class="btn btn-default">Detail</a>
					</div>
				</div>
			</div>
		<?php endforeach ?>
